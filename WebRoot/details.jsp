	...
	<TBODY>
		<TR vAlign=top>
			...
			<table width="90%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="90" height="90" valign="top"><img
						src=<%=dish.getdishthumbilimage() %> border="0" width="80" height="80"></td>
					<td valign="top">
					<table width="98%" border="0" cellspacing="1" cellpadding="0"
						align="center">
						<tr>
							<td><strong><%=dish.getdishname() %></strong></td>
						</tr>
						<tr>
							<td height="21">原价：<strike>人民币<%=dish.getdisholdprice() %>元</strike><br>
							<font color="#ff0000">现价：人民币<%=dish.getdishnowprice() %>元</font><br>
							<%=dish.getdishdesc() %></td>
						</tr>
					</table>
					</td>
				...
				<tr>
					<td height="30">编号: <%=dish.getdishid() %></td>
					<td>
					<table width="145" border="0" cellspacing="1" cellpadding="0">
						<tr>
							<td align="center" width="70"><a href="/Restaurant/toCart?type=add&id=<%=dish.getdishid()%>">
                            <img
								src="images/buy_cn.gif" border=0 width="60" height="20"></a></td>
							<td align="center" width="70"><a href="/Restaurant/LoginCheck">返回</a></td>
						</tr>
					</table>
					</td>
				</tr>
			...
			<P align=center><IMG
				...
				height=294 alt="" hspace=0 src=<%=dish.getdishlargeimage() %> width=350
				border=0></P>
